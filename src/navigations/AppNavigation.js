...
import { HomeIcon, ChartBarIcon, UserIcon, EllipsisHorizontalIcon } from "react-native-heroicons/outline";
  ...
  return (
    <Tab.Navigator
      ...
      <Tab.Screen
        ...
        options={{
          tabBarIcon: ({ color, size }) => <ChartBarIcon name="home" color={color} size={size} />,
        }}
      />
      <Tab.Screen
        name="test3"
      ...
      <Tab.Screen
        ...
        component={TestScreen2Page}
        options={{
          tabBarIcon: ({ color, size }) => <EllipsisHorizontalIcon name="home" color={color} size={size} />,
        }}
      />
    </Tab.Navigator>
  );
